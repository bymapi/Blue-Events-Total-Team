...
//        /*  @DisplayName("Test update and event with mocked USER")
//         @Test
...
//                                 .target(Target.INTERNS)
//                                 .description("Evento para conocer gente")
//                                 .startDate(LocalDate.of(2024, 04, 11))
//                                 .endDate(LocalDate.of(2024, 05, 11))
//                                 .startTime(LocalTime.of(12, 10))
//                                 .endTime(LocalTime.of(15, 30))
//                                 .eventStatus(EventStatus.ENABLE)
//                                 .mode(Mode.ONLINE)
...
//                 eventActualizado.setAttendees(Set.of(attendeeGuardado));

                                

//                 given(eventsService.findById(eventGuardado.getId()).get()).willReturn(eventGuardado);
                                
//                 given(eventsService.eventSaved(any(Event.class)))
//                                 .willAnswer(invocation -> invocation.getArgument(0));

//                 // when

//                 ResultActions response = mockMvc.perform(put("/api/attendee/{globalId}", eventGuardado.getId())
//                                 .contentType(MediaType.APPLICATION_JSON)
//                                 .content(objectMapper.writeValueAsString(eventActualizado)).accept(MediaType.APPLICATION_JSON));
